...
print("Totally find {} words in pre-trained embeddings.".format(words_found))   # 40833
np.save(wemb_path, weights_matrix)
print('word embedding shape:', weights_matrix.shape)   # (52181, 300)
...
print("Totally find {} entities in pre-trained embeddings.".format(entities_found))   # 40833
np.save(entity_emb_path, entity_weights_matrix)
print('entity embedding shape:', entity_weights_matrix.shape)   # (42192, 100)
...
print('news embedding shape:', title_matrix.shape)   # (125592, 30)
...
print('news entity embedding shape', news_entity_matrix.shape)   # (125592, 5)
